...
public class perfectImmutableClassinJava {
    public static void main(String[] args) {
      /*lets see how to do perfect immutable class in java
        each time you get references through you have allocate in new heap and copies the original values in that heep
